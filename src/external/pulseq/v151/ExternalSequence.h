...
class ExternalSequence
{
  public:
	...
	/**
	 * @brief Get the name of an unknown label by its ID
	 * @param labelId The label ID (>= 1000 for unknown labels)
	 * @return The original label name (e.g., "TRID") or empty string if not found
	 */
	std::string GetUnknownLabelName(int labelId) const;
